    ...
    <div class="swiper-wrapper">
         <section class="swiper-slide swiper-slide-v1">
           ...
           <div class="page_container">
             <img id = "page1_title_img" class= "ani" swiper-animate-effect="zoomInDown" swiper-animate-duration="0.5s" src="images/1/title.png"/>
         ...
         <section class="swiper-slide swiper-slide-v2" >
           ...
           <div class="page_container">
             ...
             <div class = "circle_div ani" swiper-animate-effect="rollIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">
         ...
         <section class="swiper-slide swiper-slide-v3" >
           ...
           <div class="page_container">
             ...
             <div class = "circle_div ani" swiper-animate-effect="rollIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">
               <img class = "circle_light_img thisRotate" src="images/2/circle_light.png"/>
             ...
             <div class = "page3_text_div ani" swiper-animate-effect="bounceInUp" swiper-animate-duration="0.5s" swiper-animate-delay="1s" swiper-animate-delay="0.7s">
         ...
         <section class="swiper-slide swiper-slide-v4" >
           ...
           <div class="page_container">
             ...
             <div class = "circle_div_4 ani" swiper-animate-effect="rollIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">
               <img class = "circle_light_img thisRotate" src="images/2/circle_light.png"/>
         ...
         <section class="swiper-slide swiper-slide-v5" >
           ...
           <div class="page_container">
             ...
             <div class= "ani" swiper-animate-effect="slideInLeft" swiper-animate-duration="0.5s">
             ...
             <div class= "ani" swiper-animate-effect="slideInRight" swiper-animate-duration="0.5s">
         ...
         <section class="swiper-slide swiper-slide-v6" >
           ...
           <div class="page_container">
             ...
             <div class = "circle_div_6 ani" swiper-animate-effect="rollIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">
             ...
             <div class= "ani" swiper-animate-effect="zoomIn" swiper-animate-duration="0.5s" swiper-animate-delay="0.7s">
